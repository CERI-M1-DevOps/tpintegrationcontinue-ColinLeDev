...
class ListeSimpleTest {
    ...
    void modifiePremierElementAbsent() {
        ...
        assertEquals(4, listeATester.tete.getSuivant().getSuivant().getElement());
    }
    ...
    @Test
    void echangerDeuxFoisLeMemeNoeud() {
        listeATester.ajout(4);
        listeATester.ajout(5);
        Noeud r = listeATester.tete;
        listeATester.ajout(3);
        listeATester.ajout(2);
        assertEquals("ListeSimple(Noeud(2), Noeud(3), Noeud(5), Noeud(4))", listeATester.toString());
